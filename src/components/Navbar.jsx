...
import NavLogo from '../../public/assets/agustinnarciande.png'
...
export default function Navbar() {
    ...
    return (
        <div className='fixed w-full h-20 shadow-xl z-[100]'>
            <div className="flex justify-between items-center w-sfull h-full px-2 2xl:px-16">
            ...
            <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen transition-colors duration-500 bg-black/70' : ''}>
                <div 
                className={
                    nav 
                ...
                >
                    <div>
                        ...
                        <div className='border-b border-gray-300 my-4'>
                            <p className='w-[75%] md:w-[90%] py-4'>Lets build something legendary together</p>
                        </div>
                    </div>
